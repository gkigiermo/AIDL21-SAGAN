...
def main():
    ...
    path_val_reduced = root_path + 'val_reduced_gan.csv'
    ...
    '''
    train_loader = DataLoader(train_dataset, batch_size = hparams["batch_size"], sampler = ImbalancedDatasetSampler(
        train_dataset, callback_get_label = callback_get_label))
    torch.save(train_loader, './Data/train_loader_dcsngan.pt')
    print("Train loader balanced")
    '''
    # val_loader = DataLoader(val_dataset,batch_size=hparams["batch_size"], sampler=ImbalancedDatasetSampler(
    #                                  val_dataset,callback_get_label=callback_get_label))
    # torch.save(val_loader, './Data/val_loader_gan.pt')

    # print("Val loader balanced")
    # test_loader = DataLoader(test_dataset, batch_size=hparams["batch_size"])
    # Cargar balanced models
    # print(path_train_dloader)
    train_loader = torch.load(path_train_dloader)
