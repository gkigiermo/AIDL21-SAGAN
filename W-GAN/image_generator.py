...
from models.dcgan import weights_init, Generator,  Generator_128
from models.dcgan import Critic,  Critic_128, training_loop_wgan
...
def main():
    ...
    if params['arch'] == 'Generator':
        ...
        if params['image_size'] == 64:
            ...
            netD = Critic(params['n_gpu'], nc=params['number_channels'],
            ...
            netD = Critic_128(params['n_gpu'], nc=params['number_channels'],
                                     ndf=params['dis_feature_maps']).to(device)
        ...
        G_losses, D_losses, img_list, img_list_only = training_loop_wgan(ngpu=params['n_gpu'],critic_its=params['critic_its'],gp_lambda=params['gp_lambda'],num_epochs=params['num_epochs'],
                                                                         dataloader=dataloader,netG=netG, netD=netD, device=device, criterion=criterion, nz=params['latent_vector'],
